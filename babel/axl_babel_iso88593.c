...
/**
 * @brief Creates the translation table for iso-8859-3 representation
 *  to move information from iso-8859-3 to utf-8 and viceversa.
 */
axlBabelTable * axl_babel_build_iso88593_table (void) {

	axlBabelTable * table;

	/* create the table to hold information translate iso-8859-3 encoding */
	...
	table[161].buffer[1] = (unsigned char) 166; /* 0xa6 */
	...
	table[166].buffer[1] = (unsigned char) 164; /* 0xa4 */
	...
	table[169].size      = 2;
	table[169].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[169].buffer[1] = (unsigned char) 176; /* 0xb0 */
	...
	table[171].buffer[1] = (unsigned char) 158; /* 0x9e */

	/* store item associated to code 172 */
	table[172].size      = 2;
	table[172].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[172].buffer[1] = (unsigned char) 180; /* 0xb4 */
	...
	table[177].buffer[1] = (unsigned char) 167; /* 0xa7 */
	...
	table[182].buffer[1] = (unsigned char) 165; /* 0xa5 */
	...
	table[185].size      = 2;
	table[185].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[185].buffer[1] = (unsigned char) 177; /* 0xb1 */
	...
	table[187].buffer[1] = (unsigned char) 159; /* 0x9f */

	/* store item associated to code 188 */
	table[188].size      = 2;
	table[188].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[188].buffer[1] = (unsigned char) 181; /* 0xb5 */
	...
	table[195].size      = 1;
	table[195].buffer[0] = 0; /* unsupported translation */
	...
	table[197].buffer[1] = (unsigned char) 138; /* 0x8a */

	/* store item associated to code 198 */
	table[198].size      = 2;
	table[198].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[198].buffer[1] = (unsigned char) 136; /* 0x88 */
	...
	table[208].size      = 1;
	table[208].buffer[0] = 0; /* unsupported translation */
	...
	table[213].size      = 2;
	table[213].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[213].buffer[1] = (unsigned char) 160; /* 0xa0 */
	...
	table[216].size      = 2;
	table[216].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[216].buffer[1] = (unsigned char) 156; /* 0x9c */
	...
	table[221].buffer[1] = (unsigned char) 172; /* 0xac */

	/* store item associated to code 222 */
	table[222].size      = 2;
	table[222].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[222].buffer[1] = (unsigned char) 156; /* 0x9c */
	...
	table[227].size      = 1;
	table[227].buffer[0] = 0; /* unsupported translation */
	...
	table[229].buffer[1] = (unsigned char) 139; /* 0x8b */

	/* store item associated to code 230 */
	table[230].size      = 2;
	table[230].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[230].buffer[1] = (unsigned char) 137; /* 0x89 */
	...
	table[240].size      = 1;
	table[240].buffer[0] = 0; /* unsupported translation */
	...
	table[245].size      = 2;
	table[245].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[245].buffer[1] = (unsigned char) 161; /* 0xa1 */
	...
	table[248].size      = 2;
	table[248].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[248].buffer[1] = (unsigned char) 157; /* 0x9d */
	...
	table[253].buffer[1] = (unsigned char) 173; /* 0xad */

	/* store item associated to code 254 */
	table[254].size      = 2;
	table[254].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[254].buffer[1] = (unsigned char) 157; /* 0x9d */
...
} /* end axl_babel_build_iso88593_table */
