...
/**
 * @brief Creates the translation table for iso-8859-4 representation
 *  to move information from iso-8859-4 to utf-8 and viceversa.
 */
axlBabelTable * axl_babel_build_iso88594_table (void) {

	axlBabelTable * table;

	/* create the table to hold information translate iso-8859-4 encoding */
	...
	table[162].size      = 2;
	table[162].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[162].buffer[1] = (unsigned char) 184; /* 0xb8 */

	/* store item associated to code 163 */
	table[163].size      = 2;
	table[163].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[163].buffer[1] = (unsigned char) 150; /* 0x96 */
	...
	table[165].buffer[1] = (unsigned char) 168; /* 0xa8 */

	/* store item associated to code 166 */
	table[166].size      = 2;
	table[166].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[166].buffer[1] = (unsigned char) 187; /* 0xbb */
	...
	table[170].size      = 2;
	table[170].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[170].buffer[1] = (unsigned char) 146; /* 0x92 */

	/* store item associated to code 171 */
	table[171].size      = 2;
	table[171].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[171].buffer[1] = (unsigned char) 162; /* 0xa2 */

	/* store item associated to code 172 */
	table[172].size      = 2;
	table[172].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[172].buffer[1] = (unsigned char) 166; /* 0xa6 */
	...
	table[179].buffer[1] = (unsigned char) 151; /* 0x97 */
	...
	table[181].buffer[1] = (unsigned char) 169; /* 0xa9 */

	/* store item associated to code 182 */
	table[182].size      = 2;
	table[182].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[182].buffer[1] = (unsigned char) 188; /* 0xbc */
	...
	table[186].size      = 2;
	table[186].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[186].buffer[1] = (unsigned char) 147; /* 0x93 */

	/* store item associated to code 187 */
	table[187].size      = 2;
	table[187].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[187].buffer[1] = (unsigned char) 163; /* 0xa3 */

	/* store item associated to code 188 */
	table[188].size      = 2;
	table[188].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[188].buffer[1] = (unsigned char) 167; /* 0xa7 */

	/* store item associated to code 189 */
	table[189].size      = 2;
	table[189].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[189].buffer[1] = (unsigned char) 138; /* 0x8a */
	...
	table[191].buffer[1] = (unsigned char) 139; /* 0x8b */

	/* store item associated to code 192 */
	table[192].size      = 2;
	table[192].buffer[0] = (unsigned char) 196; /* 0xc4 */
	...
	table[199].size      = 2;
	table[199].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[199].buffer[1] = (unsigned char) 174; /* 0xae */
	...
	table[204].buffer[1] = (unsigned char) 150; /* 0x96 */
	...
	table[207].buffer[1] = (unsigned char) 170; /* 0xaa */
	...
	table[209].buffer[1] = (unsigned char) 133; /* 0x85 */

	/* store item associated to code 210 */
	table[210].size      = 2;
	table[210].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[210].buffer[1] = (unsigned char) 140; /* 0x8c */

	/* store item associated to code 211 */
	table[211].size      = 2;
	table[211].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[211].buffer[1] = (unsigned char) 182; /* 0xb6 */
	...
	table[217].buffer[1] = (unsigned char) 178; /* 0xb2 */
	...
	table[221].size      = 2;
	table[221].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[221].buffer[1] = (unsigned char) 168; /* 0xa8 */

	/* store item associated to code 222 */
	table[222].size      = 2;
	table[222].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[222].buffer[1] = (unsigned char) 170; /* 0xaa */
	...
	table[224].size      = 2;
	table[224].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[224].buffer[1] = (unsigned char) 129; /* 0x81 */
	...
	table[231].size      = 2;
	table[231].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[231].buffer[1] = (unsigned char) 175; /* 0xaf */
	...
	table[236].buffer[1] = (unsigned char) 151; /* 0x97 */
	...
	table[239].buffer[1] = (unsigned char) 171; /* 0xab */
	...
	table[241].buffer[1] = (unsigned char) 134; /* 0x86 */

	/* store item associated to code 242 */
	table[242].size      = 2;
	table[242].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[242].buffer[1] = (unsigned char) 141; /* 0x8d */

	/* store item associated to code 243 */
	table[243].size      = 2;
	table[243].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[243].buffer[1] = (unsigned char) 183; /* 0xb7 */
	...
	table[249].buffer[1] = (unsigned char) 179; /* 0xb3 */
	...
	table[253].size      = 2;
	table[253].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[253].buffer[1] = (unsigned char) 169; /* 0xa9 */

	/* store item associated to code 254 */
	table[254].size      = 2;
	table[254].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[254].buffer[1] = (unsigned char) 171; /* 0xab */
...
} /* end axl_babel_build_iso88594_table */
