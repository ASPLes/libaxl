/**
 * Axl Babel: encoding support for axl: iso-8859-2 coding
...
/**
 * @brief Creates the translation table for iso-8859-2 representation
 *  to move information from iso-8859-2 to utf-8 and viceversa.
 */
axlBabelTable * axl_babel_build_iso88592_table (void) {

	axlBabelTable * table;

	/* create the table to hold information translate iso-8859-2 encoding */
	...
	table[161].size      = 2;
	table[161].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[161].buffer[1] = (unsigned char) 132; /* 0x84 */

	/* store item associated to code 162 */
	table[162].size      = 2;
	table[162].buffer[0] = (unsigned char) 203; /* 0xcb */
	table[162].buffer[1] = (unsigned char) 152; /* 0x98 */

	/* store item associated to code 163 */
	table[163].size      = 2;
	table[163].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[163].buffer[1] = (unsigned char) 129; /* 0x81 */
	...
	table[165].size      = 2;
	table[165].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[165].buffer[1] = (unsigned char) 189; /* 0xbd */

	/* store item associated to code 166 */
	table[166].size      = 2;
	table[166].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[166].buffer[1] = (unsigned char) 154; /* 0x9a */
	...
	table[169].size      = 2;
	table[169].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[169].buffer[1] = (unsigned char) 160; /* 0xa0 */

	/* store item associated to code 170 */
	table[170].size      = 2;
	table[170].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[170].buffer[1] = (unsigned char) 158; /* 0x9e */

	/* store item associated to code 171 */
	table[171].size      = 2;
	table[171].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[171].buffer[1] = (unsigned char) 164; /* 0xa4 */

	/* store item associated to code 172 */
	table[172].size      = 2;
	table[172].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[172].buffer[1] = (unsigned char) 185; /* 0xb9 */
	...
	table[174].size      = 2;
	table[174].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[174].buffer[1] = (unsigned char) 189; /* 0xbd */

	/* store item associated to code 175 */
	table[175].size      = 2;
	table[175].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[175].buffer[1] = (unsigned char) 187; /* 0xbb */
	...
	table[177].size      = 2;
	table[177].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[177].buffer[1] = (unsigned char) 133; /* 0x85 */

	/* store item associated to code 178 */
	table[178].size      = 2;
	table[178].buffer[0] = (unsigned char) 203; /* 0xcb */
	table[178].buffer[1] = (unsigned char) 155; /* 0x9b */

	/* store item associated to code 179 */
	table[179].size      = 2;
	table[179].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[179].buffer[1] = (unsigned char) 130; /* 0x82 */

	/* store item associated to code 180 */
	table[180].size      = 2;
	table[180].buffer[0] = (unsigned char) 194; /* 0xc2 */
	table[180].buffer[1] = (unsigned char) 180; /* 0xb4 */

	/* store item associated to code 181 */
	table[181].size      = 2;
	table[181].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[181].buffer[1] = (unsigned char) 190; /* 0xbe */

	/* store item associated to code 182 */
	table[182].size      = 2;
	table[182].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[182].buffer[1] = (unsigned char) 155; /* 0x9b */

	/* store item associated to code 183 */
	table[183].size      = 2;
	table[183].buffer[0] = (unsigned char) 203; /* 0xcb */
	table[183].buffer[1] = (unsigned char) 135; /* 0x87 */

	/* store item associated to code 184 */
	table[184].size      = 2;
	table[184].buffer[0] = (unsigned char) 194; /* 0xc2 */
	table[184].buffer[1] = (unsigned char) 184; /* 0xb8 */

	/* store item associated to code 185 */
	table[185].size      = 2;
	table[185].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[185].buffer[1] = (unsigned char) 161; /* 0xa1 */

	/* store item associated to code 186 */
	table[186].size      = 2;
	table[186].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[186].buffer[1] = (unsigned char) 159; /* 0x9f */

	/* store item associated to code 187 */
	table[187].size      = 2;
	table[187].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[187].buffer[1] = (unsigned char) 165; /* 0xa5 */

	/* store item associated to code 188 */
	table[188].size      = 2;
	table[188].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[188].buffer[1] = (unsigned char) 186; /* 0xba */

	/* store item associated to code 189 */
	table[189].size      = 2;
	table[189].buffer[0] = (unsigned char) 203; /* 0xcb */
	table[189].buffer[1] = (unsigned char) 157; /* 0x9d */

	/* store item associated to code 190 */
	table[190].size      = 2;
	table[190].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[190].buffer[1] = (unsigned char) 190; /* 0xbe */

	/* store item associated to code 191 */
	table[191].size      = 2;
	table[191].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[191].buffer[1] = (unsigned char) 188; /* 0xbc */

	/* store item associated to code 192 */
	table[192].size      = 2;
	table[192].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[192].buffer[1] = (unsigned char) 148; /* 0x94 */
	...
	table[195].size      = 2;
	table[195].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[195].buffer[1] = (unsigned char) 130; /* 0x82 */
	...
	table[197].size      = 2;
	table[197].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[197].buffer[1] = (unsigned char) 185; /* 0xb9 */

	/* store item associated to code 198 */
	table[198].size      = 2;
	table[198].buffer[0] = (unsigned char) 196; /* 0xc4 */
	...
	table[200].size      = 2;
	table[200].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[200].buffer[1] = (unsigned char) 140; /* 0x8c */
	...
	table[202].size      = 2;
	table[202].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[202].buffer[1] = (unsigned char) 152; /* 0x98 */
	...
	table[204].size      = 2;
	table[204].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[204].buffer[1] = (unsigned char) 154; /* 0x9a */
	...
	table[207].size      = 2;
	table[207].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[207].buffer[1] = (unsigned char) 142; /* 0x8e */

	/* store item associated to code 208 */
	table[208].size      = 2;
	table[208].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[208].buffer[1] = (unsigned char) 144; /* 0x90 */

	/* store item associated to code 209 */
	table[209].size      = 2;
	table[209].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[209].buffer[1] = (unsigned char) 131; /* 0x83 */

	/* store item associated to code 210 */
	table[210].size      = 2;
	table[210].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[210].buffer[1] = (unsigned char) 135; /* 0x87 */
	...
	table[213].size      = 2;
	table[213].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[213].buffer[1] = (unsigned char) 144; /* 0x90 */
	...
	table[216].size      = 2;
	table[216].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[216].buffer[1] = (unsigned char) 152; /* 0x98 */

	/* store item associated to code 217 */
	table[217].size      = 2;
	table[217].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[217].buffer[1] = (unsigned char) 174; /* 0xae */
	...
	table[219].size      = 2;
	table[219].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[219].buffer[1] = (unsigned char) 176; /* 0xb0 */
	...
	table[222].size      = 2;
	table[222].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[222].buffer[1] = (unsigned char) 162; /* 0xa2 */
	...
	table[224].size      = 2;
	table[224].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[224].buffer[1] = (unsigned char) 149; /* 0x95 */
	...
	table[227].size      = 2;
	table[227].buffer[0] = (unsigned char) 196; /* 0xc4 */
	...
	table[229].size      = 2;
	table[229].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[229].buffer[1] = (unsigned char) 186; /* 0xba */

	/* store item associated to code 230 */
	table[230].size      = 2;
	table[230].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[230].buffer[1] = (unsigned char) 135; /* 0x87 */
	...
	table[232].size      = 2;
	table[232].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[232].buffer[1] = (unsigned char) 141; /* 0x8d */
	...
	table[234].size      = 2;
	table[234].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[234].buffer[1] = (unsigned char) 153; /* 0x99 */
	...
	table[236].size      = 2;
	table[236].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[236].buffer[1] = (unsigned char) 155; /* 0x9b */
	...
	table[239].size      = 2;
	table[239].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[239].buffer[1] = (unsigned char) 143; /* 0x8f */

	/* store item associated to code 240 */
	table[240].size      = 2;
	table[240].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[240].buffer[1] = (unsigned char) 145; /* 0x91 */

	/* store item associated to code 241 */
	table[241].size      = 2;
	table[241].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[241].buffer[1] = (unsigned char) 132; /* 0x84 */

	/* store item associated to code 242 */
	table[242].size      = 2;
	table[242].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[242].buffer[1] = (unsigned char) 136; /* 0x88 */
	...
	table[245].size      = 2;
	table[245].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[245].buffer[1] = (unsigned char) 145; /* 0x91 */
	...
	table[248].size      = 2;
	table[248].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[248].buffer[1] = (unsigned char) 153; /* 0x99 */

	/* store item associated to code 249 */
	table[249].size      = 2;
	table[249].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[249].buffer[1] = (unsigned char) 175; /* 0xaf */
	...
	table[251].size      = 2;
	table[251].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[251].buffer[1] = (unsigned char) 177; /* 0xb1 */
	...
	table[254].size      = 2;
	table[254].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[254].buffer[1] = (unsigned char) 163; /* 0xa3 */

	/* store item associated to code 255 */
	table[255].size      = 2;
	table[255].buffer[0] = (unsigned char) 203; /* 0xcb */
	table[255].buffer[1] = (unsigned char) 153; /* 0x99 */

	/* return table created */
	return table;

} /* end axl_babel_build_iso88592_table */
