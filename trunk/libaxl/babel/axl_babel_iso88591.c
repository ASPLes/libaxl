...
/**
 * @brief Creates the translation table for iso-8859-1 representation
 *  to move information from iso-8859-1 to utf-8 and viceversa.
 */
axlBabelTable * axl_babel_build_iso88591_table (void) {

	axlBabelTable * table;

	/* create the table to hold information translate iso-8859-1 encoding */
...
} /* end axl_babel_build_iso88591_table */
