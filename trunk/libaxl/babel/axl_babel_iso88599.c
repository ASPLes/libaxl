...
/**
 * @brief Creates the translation table for iso-8859-9 representation
 *  to move information from iso-8859-9 to utf-8 and viceversa.
 */
axlBabelTable * axl_babel_build_iso88599_table (void) {

	axlBabelTable * table;

	/* create the table to hold information translate iso-8859-9 encoding */
	...
	table[188].size      = 2;
	table[188].buffer[0] = (unsigned char) 194; /* 0xc2 */
	table[188].buffer[1] = (unsigned char) 188; /* 0xbc */
	...
	table[190].size      = 2;
	table[190].buffer[0] = (unsigned char) 194; /* 0xc2 */
	...
	table[208].buffer[1] = (unsigned char) 158; /* 0x9e */
	...
	table[221].size      = 2;
	table[221].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[221].buffer[1] = (unsigned char) 176; /* 0xb0 */
	...
	table[240].buffer[1] = (unsigned char) 159; /* 0x9f */
	...
	table[253].size      = 2;
	table[253].buffer[0] = (unsigned char) 196; /* 0xc4 */
	table[253].buffer[1] = (unsigned char) 177; /* 0xb1 */

	/* store item associated to code 254 */
	table[254].size      = 2;
	table[254].buffer[0] = (unsigned char) 197; /* 0xc5 */
	table[254].buffer[1] = (unsigned char) 159; /* 0x9f */
...
} /* end axl_babel_build_iso88599_table */
