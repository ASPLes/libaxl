...
struct _PyAxlHash {
	...
	/* pointer to the axl hash */
	axlHash * hash;
};

static int py_axl_hash_init_type (PyAxlHash *self, PyObject *args, PyObject *kwds)
{
    return 0;
}
 ...
 * axl.Hash
 */
static PyObject * py_axl_hash_new (PyTypeObject *type, PyObject *args, PyObject *kwds)
{
	PyAxlHash *self;

	/* create the object */
	self = (PyAxlHash *)type->tp_alloc(type, 0);
 ...
 * object axl.Hash
 */
static void py_axl_hash_dealloc (PyAxlHash* self)
{
	/* free the hash it self */
 ...
 * member access).
 */
PyObject * py_axl_hash_get_attr (PyObject *o, PyObject *attr_name) {
	const char      * attr = NULL;
	PyObject        * result;
/*	PyAxlHash        * self = (PyAxlHash *) o; */
 ...
 */
int py_axl_hash_set_attr (PyObject *o, PyObject *attr_name, PyObject *v)
{
	const char      * attr = NULL;
/*	PyAxlHash        * self = (PyAxlHash *) o; */
...
static PyMethodDef py_axl_hash_methods[] = { 
 	{NULL}  
}; 

static PyTypeObject PyAxlHashType = {
